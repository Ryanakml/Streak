...
const localTime = getArg("--time") ?? "17:00";
const resetExisting = getArg("--no-reset") ? false : true;

const client = new ConvexHttpClient(convexUrl);
const result = await client.mutation("devSeeds:seedUIDemo", {
...
console.log("\nNext:");
console.log("- Open /dashboard and review Home, Chat, Stats, and Profile.");
console.log("- Keep AI disabled in dev if you want the seeded UI state to stay static.");
