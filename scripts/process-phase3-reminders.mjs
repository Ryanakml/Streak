...
const before = Date.now() + Math.max(0, Number.isFinite(minutesAhead) ? minutesAhead : 0) * 60 * 1000;

const client = new ConvexHttpClient(convexUrl);
const result = await client.action("devSeeds:processPhase3DueReminders", {
