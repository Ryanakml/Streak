...
| **Payments**        | Polar.sh SDK                         | `npm install @polar-sh/sdk`                                        |
...
**STOP & REQUEST:** "I need your Polar.sh credentials:

- `POLAR_ACCESS_TOKEN`
- `POLAR_ORGANIZATION_ID`
- Product IDs for Free vs Pro tiers"

**Checkpoint:** Wait for credentials, then "Proceed to Phase 5b"

---

#### **Phase 5b: Implement Checkout Flow**

**Create:**

- Checkout page/component with Polar checkout session
- Webhook handler: `src/app/api/webhooks/polar/route.ts`
- Convex mutation to update user subscription tier

**Test:** Create a test checkout (Polar has test mode)

**Checkpoint:** Demo subscription upgrade flow, wait for "Proceed to Phase 6"
...
- Set up webhook URLs (Clerk + Polar) to production domain
